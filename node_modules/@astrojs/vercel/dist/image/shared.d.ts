import type { AstroConfig, ImageMetadata, ImageTransform } from 'astro';
...
export declare function getAstroImageConfig(images: boolean | undefined, imagesConfig: VercelImageConfig | undefined, command: string, devImageService: DevImageService, astroImageConfig: AstroConfig['image'], responsiveImages?: boolean): {
    image: {
        service: {
            entrypoint: string;
